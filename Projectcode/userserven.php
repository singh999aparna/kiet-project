...
include"connect.php";
	$res= mysqli_query($con,"select * from venue where v_ref='seven.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/><br />
			<h4 style="color:#FFF">
            	...
            	<a href="uservenue.php" style="color:#FFF; text-decoration:none">Venues </a> <img src="img/back-ar.gif"/><a href="userwest.php" style="color:#FFF; text-decoration:none"> </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Seven-Eleven Resort</span>  
            </h4>
		</div><br />
