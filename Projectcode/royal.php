...
include"connect.php";
	$res= mysqli_query($con,"select * from decoration where d_ref='royal.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="decoration.php" style="color:#FFF; text-decoration:none">Decoration </a> <img src="img/back-ar.gif"/> <span style="color:#FFF">Royal Decoration</span>  
            </h4>
		</div><br />
