	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/><br/>
			<h4>
            	...
            	<a href="ucont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Seminars</span>  
            </h4>
		</div><br />
...
Almost all wedding anniversary events include a reception. 
    						...
    						<a href="booking.php" style="color:#0F0; margin-left:720px; font-size:18px; font-family:'Times New Roman', Times, serif; text-shadow:#000 2px 1px 1px ">Booking</a>
             			</div>     
          			</div>
      			</div><!--Column 1 close-->
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
        						<div class="item active">
            						<img src="img/corpo/download (1).jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
					            	<img src="img/corpo/download.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
            						<img src="img/corpo/images (1).jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/corpo/images (2).jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/corpo/images (3).jpg" style="width:100%; height:200px"/>
					            </div>
             					<div class="item">
            						<img src="img/corpo/images.jpg" style="width:100%; height:200px"/>
					            </div>
					        </div>
