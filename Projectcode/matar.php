...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='matar.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="catering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="north.php" style="color:#FFF; text-decoration:none">North-Indian </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Mushroom-Matar</span>  
            </h4>
		</div><br />
