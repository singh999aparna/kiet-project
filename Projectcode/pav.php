...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='pav.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="catering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="west.php" style="color:#FFF; text-decoration:none">West-Indian </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Pav-Bhaji</span>  
            </h4>
		</div><br />
