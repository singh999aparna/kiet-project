...
include"connect.php";
	$res= mysqli_query($con,"select * from venue where v_ref='samrat.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="venue.php" style="color:#FFF; text-decoration:none">Venue </a> <img src="img/back-ar.gif"/> <span style="color:#FFF">Samrat Heaves Hotel</span>  
            </h4>
		</div><br />
        <div class="container-fluid">
    			...
    			<div class="col-sm-4" style="margin-left:5%">
          			<div class="panel panel-default panel1">
                         ...
                         <h4 style="color:#000; text-shadow:#FFF 2px 2px 2px">
                         Anurag Jain
                         </h4>
             			</div>     
          			</div>
