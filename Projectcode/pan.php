...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='pan.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="catering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="deserts.php" style="color:#FFF; text-decoration:none">Deserts </a> <img src="img/back-ar.gif"/><a href="sweet.php" style="color:#FFF; text-decoration:none">Sweets </a> <img src="img/back-ar.gif"/> <span style="color:#FFF">Kaju-Paan</span>  
            </h4>
		</div><br />
        <div class="container-fluid">
    			...
    			<div class="col-sm-5" style="margin-left:14%">
          			<div class="panel panel-default panel1">
			             ...
			             <div class="panel-body" style="text-shadow:none;background-color:#F96;box-shadow:#000 2px 3px 3px; height:160px">
