...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='kaju.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="catering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="deserts.php" style="color:#FFF; text-decoration:none">Deserts </a> <img src="img/back-ar.gif"/><a href="sweet.php" style="color:#FFF; text-decoration:none">Sweets </a> <img src="img/back-ar.gif"/> <span style="color:#FFF">Kaju-Katli</span>  
            </h4>
		</div><br />
