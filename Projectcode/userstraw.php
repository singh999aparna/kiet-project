...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='straw.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/><br />
			<h4 style="color:#FFF">
            	...
            	<a href="ucatering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="userdeserts.php" style="color:#FFF; text-decoration:none">Deserts </a><img src="img/back-ar.gif"/><a href="userice.php" style="color:#FFF; text-decoration:none">Ice-Cream </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Strawberry</span>  
            </h4>
		</div><br />
