	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/>
			<h4>
            	...
            	<a href="Cont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Reception</span>  
            </h4>
		</div><br />
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
        						<div class="item active">
            						<img src="img/reception/exhibition-stage-decoration-250x250.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
					            	<img src="img/reception/fd-55.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
