...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='uttapam.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/><br />
			<h4 style="color:#FFF">
            	...
            	<a href="ucatering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="usersouth.php" style="color:#FFF; text-decoration:none">South-Indian </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Uttapam</span>  
            </h4>
		</div><br />
