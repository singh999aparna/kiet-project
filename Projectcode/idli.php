...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='idli.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="catering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="south.php" style="color:#FFF; text-decoration:none">South-Indian </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Idli-Sambar</span>  
            </h4>
		</div><br />
