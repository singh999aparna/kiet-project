	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/>
			<h4>
            	...
            	<a href="Cont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Royal Wedding</span>  
            </h4>
		</div><br />
					...
					<div class="panel panel-default panel1">
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
            					...
            					<div class="item">
					            	<img src="img/royal/4.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
            						<img src="img/royal/1.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/royal/3.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/royal/5.jpg" style="width:100%; height:200px"/>
					            </div>
             					<div class="item">
            						<img src="img/Silver deco/3.jpg" style="width:100%; height:200px"/>
					            </div>
					        </div>
