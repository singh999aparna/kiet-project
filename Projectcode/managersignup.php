...
<div class="container container-fluid" >
	<div class="panel panel-default panel-info">
        ...
        <h1>Enter Event-Manager Information</h1>
        </div>
        <div class="panel-body" >
	        <div class="form-control-static container-fluid">
    	    	<form action="managersignupdb.php" method="post" enctype="multipart/form-data">
				...
				<div class="form-horizontal"><span class="glyphicon glyphicon-credit-card"></span>
                	<label>Address:</label>
        		        <input type="text" name="add" required class="form-control"
