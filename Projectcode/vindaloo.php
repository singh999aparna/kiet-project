...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="catering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="east.php" style="color:#FFF; text-decoration:none">East-Indian </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Chicken-Vindaloo</span>  
            </h4>
		</div><br />
