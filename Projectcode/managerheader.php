 ...
 <div class="container">
  <div class="navbar-header">
    ...
    <button type="submit" class="btn btn-success navbar-right" style="margin-right:10px; padding:10px; background:#000;box-shadow:#CCC 6px -3px 5px; color:#F96;text-shadow:#F96 1px 1px 2px; border:#000; margin-top:10px; ">
        <span class="glyphicon glyphicon-log-in"></span><a href="managerlogout.php" style="color:#F96; text-decoration:none;"> Log out</a></button>
        <button type="submit" class="btn btn-success navbar-right" style="margin-right:10px; padding:10px; background:#000;box-shadow:#CCC 6px -3px 5px; color:#F96;text-shadow:#F96 1px 1px 2px; border:#000; margin-top:10px; ">
        <span class="glyphicon glyphicon-home"></span><a href="manager.php" style="color:#F96; text-decoration:none;"> Home</a></button>
    </div>
    </div>
