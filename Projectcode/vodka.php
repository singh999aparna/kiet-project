...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/>
			<h4 style="color:#FFF">
            	...
            	<a href="catering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="beverages.php" style="color:#FFF; text-decoration:none">everages </a> <img src="img/back-ar.gif"/><a href="hard.php" style="color:#FFF; text-decoration:none">Hard-Drinks </a> <img src="img/back-ar.gif"/> <span style="color:#FFF">Vodka</span>  
            </h4>
		</div><br />
