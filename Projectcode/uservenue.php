...
<br /><br /><br />
<h4><a href="homeuser.php" style="color:#FFF; text-decoration:none"">&nbsp; Home </a> <img src="img/back-ar.gif"/><span style="color:#FFF;"> Venue</span></h4><br/>
<div class="container">	
	<?php 
   ...
   ?>
          ...
          <br/>
             <img src="<?php echo $row[2];?>" class="col-sm-3 img img-circle img-responsive" style="width:100%; height:225px"/>
             <br/>  
             <div class="panel-body" style="text-shadow:none"><br/><br/><br/><br/>
             	<h1 style="color:#900; text-shadow:#000 1px 2px 3px"><center> <a href="<?php echo $row[6];?>?e_id=<?php echo $row[0];?>" style="color:#900; text-decoration:none;"><?php echo $row[1];?></a></center></h1>
             </div>
          </div>
          </div>
             <?php } ?> 
