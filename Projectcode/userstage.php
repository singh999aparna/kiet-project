	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/><br/>
			<h4>
            	...
            	<a href="ucont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Stafe Show</span>  
            </h4>
		</div><br />
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
        						<div class="item active">
            						<img src="img/stage/1.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
					            	<img src="img/stage/2.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
            						<img src="img/stage/3.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/Silver deco/1.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/Silver deco/engagement/images (1).jpg" style="width:100%; height:200px"/>
					            </div>
					        </div>
