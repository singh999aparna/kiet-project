	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/>
			<h4>
            	...
            	<a href="Cont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Sangeet</span>  
            </h4>
		</div><br />
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
        						<div class="item active">
            						<img src="img/sangeet/2.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
					            	<img src="img/sangeet/1.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
            						<img src="img/sangeet/images (1).jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/sangeet/images (2).jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/sangeet/images.jpg" style="width:100%; height:200px"/>
					            </div>
             					<div class="item">
            						<img src="img/sangeet/12.jpg" style="width:100%; height:200px"/>
					            </div>
					        </div>
