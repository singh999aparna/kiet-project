...
include"connect.php";
	$res= mysqli_query($con,"select * from catering where c_ref='vanila.php' ")or die(mysqli_error());
...
<body background="img/ccc.jpg">
	<div class="container container-fluid"><br/><br/><br />
			<h4 style="color:#FFF">
            	...
            	<a href="ucatering.php" style="color:#FFF; text-decoration:none">Catering </a> <img src="img/back-ar.gif"/><a href="userbeverages.php" style="color:#FFF; text-decoration:none">Beverages </a><img src="img/back-ar.gif"/><a href="usershake.php" style="color:#FFF; text-decoration:none">Shakes </a><img src="img/back-ar.gif"/> <span style="color:#FFF">Vanila-Shake</span>  
            </h4>
		</div><br />
        <div class="container-fluid">
            ...
            <a href="addtocart.php?c_id=<?php echo $id; ?>&&c_price=<?php echo $price; ?>"><button type="submit" name="add" class="form-control btn btn-xs btn-success" style="width:25%; margin-left:63%"><span class="glyphicon glyphicon-shopping-cart"></span> Add to cart</button></a>
        </div>
		<br/><br />
