	...
	<body background="img/ccc.jpg">
		<div class="container container-fluid"><br/><br/>
			<h4>
            	...
            	<a href="Cont.php" style="color:#FFF; text-decoration:none">Events </a> <img src="img/back-ar.gif"/>  <span style="color:#FFF">Mehendi</span>  
            </h4>
		</div><br />
						...
						<div id="slider" class="carousel slide">
    						<div class="carousel-inner">
        						<div class="item active">
            						<img src="img/mehendi/1.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
					            	<img src="img/mehendi/2.jpg" style="width:100%; height:200px"/>
						        </div>
								<div class="item">
            						<img src="img/mehendi/3.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/deco/9.jpg" style="width:100%; height:200px"/>
					            </div>
            					<div class="item">
            						<img src="img/deco/4.jpg" style="width:100%; height:200px"/>
					            </div>
             					<div class="item">
            						<img src="img/deco/6.jpg" style="width:100%; height:200px"/>
					            </div>
					        </div>
