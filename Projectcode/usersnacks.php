...
include"connect.php";
  $res= mysqli_query($con,"select * from catering where c_descri = 'snacks' ")or die(mysqli_error());
...
<br /><br /><br />
<h4><a href="homeuser.php" style="color:#F00; text-shadow:#666 0px 1px 0px;text-decoration:none">&nbsp; Home </a> <img src="img/back-ar.gif"/><span style="color:#F00; text-shadow:#666 0px 1px 0px;text-decoration:none"><a href="ucatering.php" style="color:#F00; text-shadow:#666 0px 1px 0px;text-decoration:none"> Catering</a></span>&nbsp; <img src="img/back-ar.gif"/><span style="color:#F00; text-shadow:#666 0px 1px 0px;"> Snacks</span></h4><br/>
<div class="container">	
	<?php 
